...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `TreeSitterBash.swiftmodule/`
...
//      `import TreeSitterBash` above would fail at compile time.
//
//   2. The static archive `libTreeSitterBash.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "TreeSitterBash" }` and
//      `flattenPackage = "io.github.kotlinmania.treesitterbash"` configuration in
...
//      via the `TreeSitterBashLibrary` product.
//
...
final class TreeSitterBashExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "TreeSitterBash swift module imported cleanly")
    }
}
