...
This file is the quick-reference operating contract for tree-sitter-bash-kotlin. The longer
...
tree-sitter-bash-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tree-sitter-bash`](https://crates.io/crates/tree-sitter-bash). Upstream Rust is the behavioral oracle while the
