...
val generateBundledTreeSitterBashResources = tasks.register("generateBundledTreeSitterBashResources") {
    description = "Generate commonMain Kotlin source embedding the bundled tree-sitter-bash resources."
    group = "build"
    val nodeTypesFile = layout.projectDirectory.file(
        "src/commonMain/resources/io/github/kotlinmania/treesitterbash/node-types.json",
    )
    val highlightsFile = layout.projectDirectory.file(
    ...
    doLast {
        ...
        pkgDir.resolve("BundledResources.kt").writeText(
            """
            // Generated from src/commonMain/resources/io/github/kotlinmania/treesitterbash/
            ...
            internal val BUNDLED_TREE_SITTER_BASH_RESOURCES: Map<String, String> = mapOf(
...
kotlin {
    ...
    val xcf = XCFramework("TreeSitterBash")
    ...
    swiftExport {
        moduleName = "TreeSitterBash"
        flattenPackage = "io.github.kotlinmania.treesitterbash"
    }

    android {
        namespace = "io.github.kotlinmania.treesitterbash"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    pom {
        name.set("tree-sitter-bash-kotlin")
        description.set("Kotlin Multiplatform port of tree-sitter/tree-sitter-bash - Bash grammar for tree-sitter")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tree-sitter-bash-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tree-sitter-bash-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tree-sitter-bash-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tree-sitter-bash-kotlin.git")
        }
    }
}
...
val fullTargetBuildTaskNames = setOf(
    ...
    "swiftExportSmokeTest",
    "assembleTreeSitterBashXCFramework",
)
...
dependencies {
    ...
    codeqlSourceClasspath("io.github.kotlinmania:tree-sitter-language-kotlin-jvm:0.1.0")
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/treesitterbash/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.treesitterbash.codeql
